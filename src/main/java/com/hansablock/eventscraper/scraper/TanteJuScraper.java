...
public class TanteJuScraper implements Scraper {
  ...
  private Event createEventFromVEvent(VEvent vEvent) {
    ...
    LocalDateTime startDateTime =
        LocalDateTime.ofInstant(
            vEvent.getStartDate().getDate().toInstant(), ZoneId.of("Europe/Berlin"));
  ...
  private Event fetchEventDetails(
      String title, LocalDateTime startDateTime, String url, String descriptionFromIcs) {
    String price = "";
    String thumbnailUrl = "";
    ...
    String misc =
        (descriptionFromIcs == null ? "" : descriptionFromIcs) + (url == null ? "" : ("\n" + url));
  ...
  public String extractThumbnailUrl(Document doc) {
    ...
    Element thumbnailElement =
        doc.selectFirst(".news img[src$=.jpg], .news img[src$=.jpeg], .news img[src$=.png]");
