...
class ScraperParsersTest {
    ...
    void chemo_parseTime_handlesVariousFormats() {
        ...
        Element root = Jsoup.parse("<div><div class='elementor-element-6c7315b'><div class='elementor-widget-container'>Einlass: 19.30</div></div></div>").body();
        LocalTime t = chemo.parseTime(root, ".elementor-element-6c7315b .elementor-widget-container", "Einlass:");
        assertEquals(LocalTime.of(19,30), t);

        root = Jsoup.parse("<div><div class='elementor-element-c75cd6a'><div class='elementor-widget-container'>Beginn: 20:00</div></div></div>").body();
