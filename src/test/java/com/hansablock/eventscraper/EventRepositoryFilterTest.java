...
class EventRepositoryFilterTest {
    ...
    void filters_by_location_and_range_and_search() {
        ...
        Page<Event> page = eventRepository.searchUpcomingWithFilters("rock", from, to, "Scheune Dresden", PageRequest.of(0, 10));
        assertThat(page.getContent())
                .extracting(Event::getTitle)
                .containsExactly("Rock Gala");
    }

    @Test
    void returns_from_today_when_to_is_null() {
        Page<Event> page = eventRepository.searchUpcomingWithFilters(null, LocalDate.now(), null, null, PageRequest.of(0, 10));
